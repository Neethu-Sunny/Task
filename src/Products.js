...
const Myproducts =()=>{
     ...
     const getitems=useSelector(State=>State);
     let addedItems=[];
     addedItems=getitems;
        return(
            <View style={{flex:1}}>
            <View style={styles.container}>
             ...
             <TouchableOpacity
                ...
                style={{width:60,height:40,marginLeft:440}}/>    
                <Text style={{fontSize:20,fontWeight:'900'}}>{addedItems.length}</Text>
             </TouchableOpacity>
            </View>
        ...
        <Button title="asynchr" color={'green'} onPress={()=>navigation.navigate('Realmbook')}></Button>
            </View>
        )
    }
